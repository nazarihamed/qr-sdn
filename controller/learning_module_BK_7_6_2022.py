            ...
            if len(elements['currentCombination']) > 0:
                ...
                if load_level > 0:
                    ...
                    if len(temp_flows) < 1:
                        ...
                        get_average_flow_bandwidth(current_combination, flowBWdict, portBWdict)
...
def get_average_latency(current_path_combination, latency_dict):
    ...
    @return:
"""
    print("=====================latency_dict in Learning Module ========================\n")
    print("latency_dict: {}\n".format(latency_dict))
    print("===============================================================================\n")
...
def get_average_flow_bandwidth(current_path_combination, bandwidth_dict,bandwidth_port_dict):
    """
    calculates the average (latency) value of all elements of a list
    @param current_path_combination:
    @param latency_dict:
...
"""
    ...
    # print("=====================current_path_combination in Learning Module ========================\n")
    # print("current_path_combination: {}\n".format(current_path_combination))
    # print("=========================================================================================\n")
    egress_dpid=list(current_path_combination.values())[0][-1]
    # newDic=bandwidth_dict[egress_dpid]
    # keysList=[{key+'_'+keyInkey:newDic[key][keyInkey] for keyInkey in newDic[key].keys()} for key in newDic.keys()]
    # print(keysList) 
    # print("=====================bandwidth_dict in Learning Module ========================\n")
    # print("bandwidth_dict: {}\n".format(bandwidth_dict))
    # print("===============================================================================\n")
    # print("=====================bandwidth_port_dict in Learning Module ========================\n")
    # print("bandwidth_port_dict: {}\n".format(bandwidth_port_dict))
    # print("====================================================================================\n")
    # newDic=bandwidth_dict[egress_dpid]
    # newDic=[{key+'_'+keyInkey:newDic[key][keyInkey] for keyInkey in newDic[key].keys()} for key in newDic.keys()]
    # print("=====================newDic in Learning Module ========================\n")
    # print("newDic: {}\n".format(newDic))
    # print("=======================================================================\n")
    # latency_list = get_bw_costs_of_paths(latency_dict)
    # cost = 0
    # for element in latency_list:
    #     cost += element
    # avg_lat = cost / len(latency_list)
...
def get_costs_of_paths(current_path_combination, latency_dict):
    ...
    for path in current_path_combination:
        ...
        value_dict[str(current_path_combination[path])]=cost
        value_list.append(cost)
    print("=====================value_dict in Learning Module ============================\n")
    print("dictionary<path:latency>: {}\n".format(value_dict))
    print("===============================================================================\n")
    return value_list

def get_bw_costs_of_paths(flow_bandwidth_dict):
    """
    array of path costs
    @param current_path_combination:
    @param latency_dict:
    @return: array of path costs
    """
    # print("=====================flow_bandwidth_dict in get_bw_costs_of_paths in Learning Module ==============\n")
    # print("flow_bandwidth_dict: {}\n".format(flow_bandwidth_dict))
    # print("====================================================================================\n")
    value_list = []
    for flowBW in flow_bandwidth_dict:
        value_list.append(flowBW)
    # print("=====================get_costs_of_paths VALUE_LIST in Learning Module ==============\n")
    # print("VALUE_LIST: {}\n".format(value_list))
    # print("====================================================================================\n")
    return value_list
