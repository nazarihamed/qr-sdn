...
def four_switches_network():
    net = Mininet(topo=None,
                  build=False,
                  ipBase='10.0.0.0/8', link=TCLink, autoSetMacs=True)
    ...
    linkArray.append(net.addLink(s4, s6, delay='14ms',use_tbf = True, bw=3, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s1, s3, delay='10ms',use_tbf = True, bw=4, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s3, s5, delay='10ms',use_tbf = True, bw=4, max_queue_size=queue_lenght))
    linkArray.append(net.addLink(s5, s6, delay='10ms',use_tbf = True, bw=4, max_queue_size=queue_lenght))
